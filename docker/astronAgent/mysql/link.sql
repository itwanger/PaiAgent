...
INSERT INTO tools_schema (app_id, tool_id, name, description, open_api_schema, version, create_at, update_at)
VALUES (
  '680ab54f', -- app_id (VARCHAR(32)) - FIXED: use correct app_id
